...
var vnsUtil = require('../dist/index.js')
...
describe('define', function () {
  const fields = [{
    ...
    length: 32,
    allowLess: true,
    default: vnsUtil.zeros(32)
  }]

  it('should trim zeros', function () {
    var someOb = {}
    vnsUtil.defineProperties(someOb, fields)
    // Define Properties
    someOb.r = '0x00004'
  ...
  it('shouldn\'t allow wrong size for exact size requirements', function () {
    ...
    assert.throws(function () {
      ...
      vnsUtil.defineProperties(someOb, tmp)
    })
  })
  ...
  it('it should accept rlp encoded intial data', function () {
    ...
    vnsUtil.defineProperties(someOb, fields, data)
    ...
    vnsUtil.defineProperties(someOb2, fields, rlpEncoded)
    assert.equal(someOb2.serialize().toString('hex'), rlpEncoded, 'the constuctor should accept rlp encoded buffers')

    var someOb3 = {}
    vnsUtil.defineProperties(someOb3, fields, expectedArray)
  ...
  it('it should not accept invalid values in the constuctor', function () {
    var someOb = {}
    assert.throws(function () {
      vnsUtil.defineProperties(someOb, fields, 5)
    }, 'should throw on nonsensical data')

    assert.throws(function () {
      vnsUtil.defineProperties(someOb, fields, Array(6))
